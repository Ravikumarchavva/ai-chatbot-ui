  ...
  return (
    <aside className="w-64 bg-zinc-950 border-r border-zinc-800 flex flex-col">
      ...
      <div className="p-3">
        <button
          onClick={onNewChat}
          className="w-full flex items-center gap-2 px-3 py-2.5 rounded-lg border border-zinc-700 hover:bg-zinc-800 transition-colors text-sm font-medium"
        >
              ...
              {editingId === thread.id ? (
                <div className="flex items-center gap-1 px-3 py-2">
                  <input
                    ...
                    className="flex-1 bg-zinc-900 border border-zinc-700 rounded px-2 py-1 text-xs outline-none focus:border-zinc-600"
                    autoFocus
                  />
                  <button
      ...
      <div className="p-3 border-t border-zinc-800">
        <div className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-zinc-900 cursor-pointer">
